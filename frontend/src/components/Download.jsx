        ...
        <div className="flex bg-[#171616] py-[100px]">
            <div className="laptop:flex max-w-[1400px] mx-auto">
                <div className="pr-[100px] ">
                    <h1 className='whitespace-wrap uppercase text-lg text-white font-semibold laptop:text-[30px] max-w-[450px] laptop:text-white laptop:leading-[40px]'>
                    Скачайте инструкцию по&nbsp;применению и сборке уже&nbsp;сейчас               
                    </h1>
                </div>
                <div className="max-h-[50px] my-auto">
