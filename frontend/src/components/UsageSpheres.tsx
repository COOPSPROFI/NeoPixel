export default function UsageSpheresMob() {
    return (
        <div className='bg-[#1E1F21] py-[30px]'>
            <div className="laptop:max-w-[1400px] mx-auto px-[15px]">
                <div className='laptop:flex justify-between laptop:mb-[140px] pb-4'>
                    <h2 className='whitespace-nowrap uppercase text-lg text-white font-semibold laptop:text-[40px] laptop:text-white laptop:leading-[40px]'>
                        Сферы применения
                    </h2>
