...
export default function NavBarAvtors() {
  return (
      	<div className='w-full top-12 py-[30px] z-10 bg-[#1E1F21] laptop:absolute laptop:bg-transparent '>
			...
			<div className='flex laptop:justify-between laptop:items-center laptop:max-w-7xl laptop:mx-auto'>
				...
				<div className='flex items-center w-full'>
					<nav className="flex flex-wrap text-white text-sm flex-row gap-2 mx-auto laptop:gap-10 items-center laptop:leading-6 laptop:text-xl justify-center">
                        ...
                        <NavLink to="/modernpage" className="hover:text-blue-600">Модернизировать</NavLink>
                        <NavLink to="/avtorspage" className="text-blue-500">Авторы</NavLink>
					</nav>
				</div>
			</div>
		</div>
